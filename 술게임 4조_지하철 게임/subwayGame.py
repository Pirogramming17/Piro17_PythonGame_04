...
def drink_print(player_list):
    ...
    for i in range(len(player_list)):
        print(
            f"{player_list[i].name}(은)는 지금까지 {player_list[i].drink}🍺! 치사량까지 {player_list[i].max}")
    print("\n")
...
""")
    ...
    # 질문 리스트
    que_li = ["염색한 사람 접어", "반지 낀 사람 접어", "반지 낀 사람 접어", "반바지 입은 사람 접어", "술 마시고 싶은 사람 접어", "집 가고 싶은 사람 접어", "밤 샌 사람 접어", "겨울 좋은 사람 접어", "여름 좋은 사람 접어", "여행 가고 싶은 사람 접어", "번지점프 해본 사람 접어", "개발자 되고 싶은 사람 접어", "누나 있는 사람 접어", "언니 있는 사람 접어", "여동생 있는 사람 접어", "오빠 있는 사람 접어", "형 있는 사람 접어", "남동생 있는 사람 접어", "17학번 접어", "18학번 접어", "19학번 접어", "20학번 접어"
              "21학번 접어", "22학번 접어", "민트초코 안먹는 사람 접어", "민트초코 먹는 사람 접어", "부먹인 사람 접어", "찍먹인 사람 접어", "소주파인 사람 접어", "맥주파인 사람 접어", "소맥파인 사람 접어"
              ]
...
def subway_game(player_list):
    ...
    from crawl_station import crawl_station
                ...
                while(1):
                    try:
                        ...
                        if answer > len(player_list)*2 or answer < 0:
                            print(
                                f"🤪🤪🤪🤪🤪🤪🤪🤪 바보~ 외칠 수 있는 숫자는 0 ~ {len(player_list)*2}개 입니다!")
...
while(True):
    ...
    while(True):
        try:
            if(player_list[turn].state == 'player'):
                choice = input(
                    f"{player_list[turn].name}이 좋아하는 랜덤~ 게임~ 무슨~ 게임~ 게임~ 스타트~ : ")
                ...
                cont = input(
                    "술게임 진행중! 다른 사람의 턴입니다. 그만하고 싶으면 'exit'를, 계속 하시려면 아무 키나 눌러주세요! : ")
                if(cont == 'exit'):
                    print(
                        "중간에 그만두시는군요..? 뭐 .. 그럴 수 있죠.. 아쉽지만 술게임을 종료합니다! 다음에 또 봐요 안녕~~~~")
                    exit()
                else:
                    choice = str(random.randint(1, 5))
                    print(
                        f"{player_list[turn].name}이 좋아하는 랜덤~ 게임~ 무슨~ 게임~ 게임~ 스타트~ : ", choice)
                    break
        except Exception as e:
            print(e)
